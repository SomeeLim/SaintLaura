...
public class SendMessage extends AbstractController {

	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		
		String api_key = "개인key";
	    String api_secret = "개인key";
	    ...
	    params.put("from", "01092470229"); // 발신번호
	    params.put("type", "SMS"); // Message type ( SMS, LMS, MMS, ATA )
	    params.put("text", "SaintLaura 에서"+name+"님의 결제가 성공적으로 완료되었습니다."); // 문자내용    
